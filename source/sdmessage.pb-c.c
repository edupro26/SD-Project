...
void   statistics_t__init
                     (StatisticsT         *message)
{
  static const StatisticsT init_value = STATISTICS_T__INIT;
  *message = init_value;
}
size_t statistics_t__get_packed_size
                     (const StatisticsT *message)
{
  assert(message->base.descriptor == &statistics_t__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  return (StatisticsT *)
     protobuf_c_message_unpack (&statistics_t__descriptor,
                                allocator, len, data);
}
...
const ProtobufCMessageDescriptor statistics_t__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "statistics_t",
  "StatisticsT",
  ...
  sizeof(StatisticsT),
  3,
  statistics_t__field_descriptors,
  statistics_t__field_indices_by_name,
  1,  statistics_t__number_ranges,
  (ProtobufCMessageInit) statistics_t__init,
  NULL,NULL,NULL    /* reserved[123] */
};
